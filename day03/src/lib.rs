...
///
/// assert_eq!(   120, day03::part1(include_str!("input1.txt"), &cardinal));
/// assert_eq!( 2_712, day03::part1(include_str!("input2.txt"), &cardinal));
/// assert_eq!(10_336, day03::part1(include_str!("input3.txt"), &diagonal));
/// ```
